...
void renderSingle() {
  ...
  // PointLight light(cameraPosition + Eigen::Vector3f(5, 0, 0), Eigen::Vector3f(1, 1, 1));

  /*
   * 3. Renderer Setting
   */
  myClassifier classifer;
  NearestNeighbourInterpolator interpolator2;
   ...
   * 3. Render
   */
  renderer.renderFrontToBack("./forward_pre.png");
  renderer.renderBackToFront("./back_pre.png");
  
  renderer.setInterpolator((Interpolator*)&interpolator2);
  renderer.renderFrontToBack("./forward_preNN.png");
  renderer.renderBackToFront("./back_preNN.png");
}
